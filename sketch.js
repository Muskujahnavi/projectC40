...
function preload(){
  ...
  backgroundImg = loadImage("assets/img.jpg")
...
function setup() {
  ...
  gameOver = createSprite(width/8,height/2- 50);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(width/8,height/2);
...
function spawnObstacles() {
  if(frameCount%60===0) {
    var obstacle=createSprite(700,height-95,20,30);
